...
void check_source_positions(TString runNumber)
{
  ...
  if (nSources == 1) { /*outFit << xEast[0] << " " << yEast[0] << " " << sigmaEast[0] << " "
    ...
    cout << xEast[0] << " " << yEast[0] << " " << sigmaEast[0] << " "
		       << xWest[0] << " " << yWest[0] << " " << sigmaWest[0] << endl;
  }
  ...
  if (nSources == 2) {
    ...
    cout << xEast[pEastMin] << " " << yEast[pEastMin] << " " << sigmaEast[pEastMin] << " "
           << xWest[pWestMin] << " " << yWest[pWestMin] << " " << sigmaWest[pWestMin] << endl;
    cout << xEast[pEastMax] << " " << yEast[pEastMax] << " " << sigmaEast[pEastMax] << " "
           << xWest[pWestMax] << " " << yWest[pWestMax] << " " << sigmaWest[pWestMax] << endl;
  ...
  if (nSources == 3) {
    ...
    cout << xEast[pEastMin] << " " << yEast[pEastMin] << " " << sigmaEast[pEastMin] << " "
           << xWest[pWestMin] << " " << yWest[pWestMin] << " " << sigmaWest[pWestMin] << endl;
    cout << xEast[pEastMid] << " " << yEast[pEastMid] << " " << sigmaEast[pEastMid] << " "
           << xWest[pWestMid] << " " << yWest[pWestMid] << " " << sigmaWest[pWestMid] << endl;
    cout << xEast[pEastMax] << " " << yEast[pEastMax] << " " << sigmaEast[pEastMax] << " "
           << xWest[pWestMax] << " " << yWest[pWestMax] << " " << sigmaWest[pWestMax] << endl;
