...
def doBackscCorr(year,anaCh,emin,emax):
    ...
    totalFracUncertA = weightRealStats([delta_2[1][i]/(1.+delta_2[0][i]) for i in range(0,len(delta_2[0]))],statUncert,220., 670.)
    totalFracCorrA = weightRealStats([delta_2[0][i]/(1+delta_2[0][i]) for i in range(0,len(delta_2[0]))],statUncert,220., 670.)
    print
    print
    ...
    total_delta_20 = weightRealStats([delta_20[0][i]/(1+delta_20[0][i]) for i in range(0,len(delta_20[0]))],statUncert,220.,670.)
    total_delta_21 = weightRealStats([delta_21[0][i]/(1+delta_21[0][i]) for i in range(0,len(delta_21[0]))],statUncert,220.,670.)
    total_delta_22 = weightRealStats([delta_22[0][i]/(1+delta_22[0][i]) for i in range(0,len(delta_22[0]))],statUncert,220.,670.)
    total_delta_23 = weightRealStats([delta_23[0][i]/(1+delta_23[0][i]) for i in range(0,len(delta_23[0]))],statUncert,220.,670.)
    
    print
    print("Idividual fractional Correction on A")
    print("Type 0: %f"%(total_delta_20/(1.+total_delta_20)))
    print("Type 1: %f"%(total_delta_21/(1.+total_delta_21)))
    print("Type 2: %f"%(total_delta_22/(1.+total_delta_22)))
    print("Type 3: %f"%(total_delta_23/(1.+total_delta_23)))

    print
    print("Idividual fractional uncertainties on A")
    print("Type 0: %f"%fabs(delta0fracShift*total_delta_20/(1.+total_delta_20)))
    print("Type 1: %f"%fabs(delta1fracShift*total_delta_21/(1.+total_delta_21)))
    print("Type 2: %f"%fabs(delta2fracShift*total_delta_22/(1.+total_delta_22)))
    print("Type 3: %f"%fabs(delta3fracShift*total_delta_23/(1.+total_delta_23)))
    print
