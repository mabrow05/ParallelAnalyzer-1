...
void betaAsymmetryFitter(TString year="2011-2012") {
  ...
  TString fname = TString::Format("%s/Asymmetries/UNBLINDED_UnCorr_OctetAsymmetries_AnaChA_220-680_Octets_%s_BinByBin.txt",getenv("SIM_ANALYSIS_RESULTS"),octets.Data());
  ...
  fname = TString::Format("%s/Asymmetries/UNBLINDED_UnCorr_OctetAsymmetries_AnaChA_220-680_Octets_%s_BinByBin_withEnergyDependence.txt",getenv("SIM_ANALYSIS_RESULTS"),octets.Data());
