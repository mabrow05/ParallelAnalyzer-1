...
//Swank Addition
  ...
  Tout->Branch("xeRC", &xeRC, "xeRC/I");
  Tout->Branch("yeRC", &yeRC, "yeRC/I");
  ...
  //Swank Addition:
  int xeRC1,yeRC1,xwRC1,ywRC1;
  Tin->SetBranchAddress("xeRC",&xeRC1);
  Tin->SetBranchAddress("yeRC",&yeRC1);
  Tin->SetBranchAddress("xwRC",&xwRC1);
  Tin->SetBranchAddress("ywRC",&ywRC1);
