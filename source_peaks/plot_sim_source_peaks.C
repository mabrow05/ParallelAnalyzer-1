...
void plot_sim_source_peaks(TString runNumber)
{
  ...
  // Open input ntuple
  TString filenameIn;
  filenameIn  = TString(getenv("REVCALSIM"))+TString("/source_peaks/source_peaks_");
  ...
  // Output file
  TString filenameOut;
  filenameOut  = TString(getenv("REVCALSIM"))+TString("/source_peaks/source_peaks_");
  ...
  // Source #1: East
  if (useSource[0]) {
    double upperRange = 800.;
    if (sourceName[0]=="Bi") upperRange = 1600.;
    ...
    his1_E0->GetXaxis()->SetRangeUser(-20.,upperRange);
    his1_E0->Draw();
    ...
    his1_E1->GetXaxis()->SetRangeUser(-20.,upperRange);
    his1_E1->Draw();
    ...
    his1_E2->GetXaxis()->SetRangeUser(-20.,upperRange);
    his1_E2->Draw();
    ...
    his1_E3->GetXaxis()->SetRangeUser(-20.,upperRange);
    his1_E3->Draw();
    ...
    his1_W0->GetXaxis()->SetRangeUser(-20.,upperRange);
    his1_W0->Draw();
    ...
    his1_W1->GetXaxis()->SetRangeUser(-20.,upperRange);
    his1_W1->Draw();
    ...
    his1_W2->GetXaxis()->SetRangeUser(-20.,upperRange);
    his1_W2->Draw();
    ...
    his1_W3->GetXaxis()->SetRangeUser(-20.,upperRange);
    his1_W3->Draw();
  ...
  if (nSources > 1 && useSource[1]) {
    double upperRange = 800.;
    if (sourceName[1]=="Bi") upperRange = 1600.;
    ...
    his2_E0->GetXaxis()->SetRangeUser(-20.,upperRange);
    his2_E0->Draw();
    ...
    his2_E1->GetXaxis()->SetRangeUser(-20.,upperRange);
    his2_E1->Draw();
    ...
    his2_E2->GetXaxis()->SetRangeUser(-20.,upperRange);
    his2_E2->Draw();
    ...
    his2_E3->GetXaxis()->SetRangeUser(-20.,upperRange);
    his2_E3->Draw();
    ...
    his2_W0->GetXaxis()->SetRangeUser(-20.,upperRange);
    his2_W0->Draw();
    ...
    his2_W1->GetXaxis()->SetRangeUser(-20.,upperRange);
    his2_W1->Draw();
    ...
    his2_W2->GetXaxis()->SetRangeUser(-20.,upperRange);
    his2_W2->Draw();
    ...
    his2_W3->GetXaxis()->SetRangeUser(-20.,upperRange);
    his2_W3->Draw();
  ...
  if (nSources > 2 && useSource[2]) {
    double upperRange = 800.;
    if (sourceName[2]=="Bi") upperRange = 1600.;
    ...
    his3_E0->GetXaxis()->SetRangeUser(-20.,upperRange);
    his3_E0->Draw();
    ...
    his3_E1->GetXaxis()->SetRangeUser(-20.,upperRange);
    his3_E1->Draw();
    ...
    his3_E2->GetXaxis()->SetRangeUser(-20.,upperRange);
    his3_E2->Draw();
    ...
    his3_E3->GetXaxis()->SetRangeUser(-20.,upperRange);
    his3_E3->Draw();
    ...
    his3_W0->GetXaxis()->SetRangeUser(-20.,upperRange);
    his3_W0->Draw();
    ...
    his3_W1->GetXaxis()->SetRangeUser(-20.,upperRange);
    his3_W1->Draw();
    ...
    his3_W2->GetXaxis()->SetRangeUser(-20.,upperRange);
    his3_W2->Draw();
    ...
    his3_W3->GetXaxis()->SetRangeUser(-20.,upperRange);
    his3_W3->Draw();
