...
void plotGainTimeDependence(TString year) {
  ...
  if (year==TString("2011-2012") ) {
    runMin = 17359;//17079;//Skipping first Xe run period due to not using it for anything
    runMax = 20000;
  }
  else {
    runMin = 20000;
  ...
  for (Int_t rn=runMin; rn<runMax; rn++) {
    ...
    if (gainFile.is_open()) {
      ...
      runNumber.push_back(rn);
      eastGain[0].push_back(e1);
      eastGain[1].push_back(e2);
      eastGain[2].push_back(e3);
      eastGain[3].push_back(e4);
      westGain[0].push_back(w1);
      westGain[1].push_back(w2);
      westGain[2].push_back(w3);
      westGain[3].push_back(w4);
  ...
  TGraph *east1 = new TGraph(runNumber.size(),&runNumber[0],&eastGain[0][0]);
  ...
  TGraph *east2 = new TGraph(runNumber.size(),&runNumber[0],&eastGain[1][0]);
  ...
  TGraph *east3 = new TGraph(runNumber.size(),&runNumber[0],&eastGain[2][0]);
  ...
  TGraph *east4 = new TGraph(runNumber.size(),&runNumber[0],&eastGain[3][0]);
  ...
  TGraph *west1 = new TGraph(runNumber.size(),&runNumber[0],&westGain[0][0]);
  ...
  TGraph *west2 = new TGraph(runNumber.size(),&runNumber[0],&westGain[1][0]);
  ...
  TGraph *west3 = new TGraph(runNumber.size(),&runNumber[0],&westGain[2][0]);
  ...
  TGraph *west4 = new TGraph(runNumber.size(),&runNumber[0],&westGain[3][0]);
